...
e.preventDefault()
    if(props.checkIfEmpty(set.timed, set.reps, set.weight)) return alert('Fill out form')
    
    if ( !props.checkIfNumber(set.timed) || !props.checkIfNumber(set.reps) || !props.checkIfNumber(set.weight) || !props.checkIfNumber(set.setCount)) {
